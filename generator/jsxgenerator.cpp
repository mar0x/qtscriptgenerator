...
{
    s << "/*" << Qt::endl
      << " * JSX wrapper code generated by JSXgenerator." << Qt::endl
      << " *" << Qt::endl
      << " * " << title << Qt::endl
      << " *" << Qt::endl
      << " * Note: DO NOT EDIT THIS FILE" << Qt::endl
      << " */" << Qt::endl;
}
...
{
    stream << "import \"qt/" << filename << ".jsx\";" << Qt::endl;
}
...
void JSXGenerator::generate()
{
    ...
    }
    {
        ...
        for (it = packHash.constBegin(); it != packHash.constEnd(); ++it) {
            ...
            for (int i = 0; i < classesInPackage.size(); ++i) {
                ...
                file.stream << "import \"qt/" << fileName << "\"; // " << cls->name() << Qt::endl;
            }
        }
    }

    {
        ...
        for (it = _signals.constBegin(); it != _signals.constEnd(); ++it) {
            file.stream << "native __fake__ class QtJSX" << it.key() << "Signal {" << Qt::endl
                        << "    function connect(callback : ("
                            << it.value() << ") -> void): void;" << Qt::endl
...

    {
        ...
        file.stream << Qt::endl
            << "native __fake__ class Qt_QVariant_Type {}" << Qt::endl
            << "native class QVariant {" << Qt::endl
            << "    static const Invalid : Qt_QVariant_Type;" << Qt::endl
            << "    static const BitArray : Qt_QVariant_Type;" << Qt::endl
            << "    static const Bitmap : Qt_QVariant_Type;" << Qt::endl
            << "    static const Bool : Qt_QVariant_Type;" << Qt::endl
            << "    static const Brush : Qt_QVariant_Type;" << Qt::endl
            << "    static const ByteArray : Qt_QVariant_Type;" << Qt::endl
            << "    static const Char : Qt_QVariant_Type;" << Qt::endl
            << "    static const Color : Qt_QVariant_Type;" << Qt::endl
            << "    static const Cursor : Qt_QVariant_Type;" << Qt::endl
            << "    static const Date : Qt_QVariant_Type;" << Qt::endl
            << "    static const DateTime : Qt_QVariant_Type;" << Qt::endl
            << "    static const Double : Qt_QVariant_Type;" << Qt::endl
            << "    static const EasingCurve : Qt_QVariant_Type;" << Qt::endl
            << "    static const Font : Qt_QVariant_Type;" << Qt::endl
            << "    static const Hash : Qt_QVariant_Type;" << Qt::endl
            << "    static const Icon : Qt_QVariant_Type;" << Qt::endl
            << "    static const Image : Qt_QVariant_Type;" << Qt::endl
            << "    static const Int : Qt_QVariant_Type;" << Qt::endl
            << "    static const KeySequence : Qt_QVariant_Type;" << Qt::endl
            << "    static const Line : Qt_QVariant_Type;" << Qt::endl
            << "    static const LineF : Qt_QVariant_Type;" << Qt::endl
            << "    static const List : Qt_QVariant_Type;" << Qt::endl
            << "    static const Locale : Qt_QVariant_Type;" << Qt::endl
            << "    static const LongLong : Qt_QVariant_Type;" << Qt::endl
            << "    static const Map : Qt_QVariant_Type;" << Qt::endl
            << "    static const Matrix : Qt_QVariant_Type;" << Qt::endl
            << "    static const Transform : Qt_QVariant_Type;" << Qt::endl
            << "    static const Matrix4x4 : Qt_QVariant_Type;" << Qt::endl
            << "    static const Palette : Qt_QVariant_Type;" << Qt::endl
            << "    static const Pen : Qt_QVariant_Type;" << Qt::endl
            << "    static const Pixmap : Qt_QVariant_Type;" << Qt::endl
            << "    static const Point : Qt_QVariant_Type;" << Qt::endl
            << "    static const PointArray : Qt_QVariant_Type;" << Qt::endl
            << "    static const PointF : Qt_QVariant_Type;" << Qt::endl
            << "    static const Polygon : Qt_QVariant_Type;" << Qt::endl
            << "    static const Quaternion : Qt_QVariant_Type;" << Qt::endl
            << "    static const Rect : Qt_QVariant_Type;" << Qt::endl
            << "    static const RectF : Qt_QVariant_Type;" << Qt::endl
            << "    static const RegExp : Qt_QVariant_Type;" << Qt::endl
            << "    static const Region : Qt_QVariant_Type;" << Qt::endl
            << "    static const Size : Qt_QVariant_Type;" << Qt::endl
            << "    static const SizeF : Qt_QVariant_Type;" << Qt::endl
            << "    static const SizePolicy : Qt_QVariant_Type;" << Qt::endl
            << "    static const String : Qt_QVariant_Type;" << Qt::endl
            << "    static const StringList : Qt_QVariant_Type;" << Qt::endl
            << "    static const TextFormat : Qt_QVariant_Type;" << Qt::endl
            << "    static const TextLength : Qt_QVariant_Type;" << Qt::endl
            << "    static const Time : Qt_QVariant_Type;" << Qt::endl
            << "    static const UInt : Qt_QVariant_Type;" << Qt::endl
            << "    static const ULongLong : Qt_QVariant_Type;" << Qt::endl
            << "    static const Url : Qt_QVariant_Type;" << Qt::endl
            << "    static const Vector2D : Qt_QVariant_Type;" << Qt::endl
            << "    static const Vector3D : Qt_QVariant_Type;" << Qt::endl
            << "    static const Vector4D : Qt_QVariant_Type;" << Qt::endl
            << "    static const UserType : Qt_QVariant_Type;" << Qt::endl
            << "}" << Qt::endl;
    }
}
...
static void writeSignal(QTextStream &s, const AbstractMetaClass *meta_class, const AbstractMetaFunctionList &funs, QMap<QString, QString> &nativeTypes, QMap<QString, QString> &signalFunctions, QSet<QString> &includes, QStringList &signalAliases)
{
    ...
    if (shortestfun)
    {
        ...
        s << " : QtJSX";
        s << signalNameString << "Signal;" << Qt::endl;
...
static void writeProperty(QTextStream &s, const AbstractMetaClass *meta_class, const QPropertySpec *prop, QMap<QString, QString> &nativeTypes, QSet<QString> &includes)
{
    ...
    s << "    var " << propName << " : " << finalTypeName << ";" << Qt::endl;
...
void JSXGenerator::write(QTextStream &o, const AbstractMetaClass *meta_class)
{
...

    {
        ...
        for (int i = 0; i < enums.size(); ++i) {
            ...
            s << "final native class " << classname << "_" << enom->name() << " {}" << Qt::endl << Qt::endl;
            ...
            if (flags)
            {
                ...
                s << "final native class " << jsxName << " {}" << Qt::endl << Qt::endl;
    ...
    {
        s << "native class " << meta_class->name() << " extends " << meta_class->baseClassName() << Qt::endl;
    ...
    else if (!meta_class->interfaces().isEmpty())
    {
        ...
        if (impl != meta_class) {
            s << "native class " << meta_class->name() << " extends " << impl->name() << Qt::endl;
            addIncludeFile(includes, impl->name());
        } else {
            s << "native class " << meta_class->name() << Qt::endl;
        }
    }
    else
    {
...

    {
        ...
        for (int i = 0; i < enums.size(); ++i) {
            ...
            for (int j = 0; j < indexes.size(); ++j) {
                ...
                s << "    static const " << val->name() << " : " << enomName << ";" << Qt::endl;
            }
            s << "    static function " << enom->name() << "(value : " << enomName << ") : " << enomName << ";" << Qt::endl;
    ...
    if (!prototypeFunctions.isEmpty()) {
        ...
        {
            s << "    function begin (arg__1 : QWidget) : boolean;" << Qt::endl;
